  ...
  return (
    <main className="app-shell">
      ...
      <aside className="sidebar">
        <div className="brand"><img className="brand-logo" src="/nova-group-logo-light.png" alt="Nova Group" /><div className="brand-app"><strong>QUẢN LÝ<br />TIẾN ĐỘ TỔNG THỂ DỰ ÁN</strong></div></div>
